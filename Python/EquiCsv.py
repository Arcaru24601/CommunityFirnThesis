...
def csv_gen_amp(mode, multp):
    ...
    np.savetxt('CFM/CFM_main/CFMinput/EquiAmp/'+str(mode)+'/' + str(multp) + '/Acc.csv',Bdot_csv,delimiter=',')
    np.savetxt('CFM/CFM_main/CFMinput/EquiAmp/'+str(mode)+'/' + str(multp) + '/Temp.csv',Temp_csv,delimiter=',')
