# -*- coding: utf-8 -*-
"""
Created on Sun Apr 23 16:54:09 2023
...
def reset_to_factory():
    ...
    file = open(r'D:/GitHub/CommunityFirnThesis/CommunityFirnThesis/Python/CFM/CFM_main/Air_OptiNoise_Ulti.json')
    data = json.load(file)
    data['Diffu_param'] = 'Schwander'
    data['noisy_bco'] = False
    with open(r"D:/GitHub/CommunityFirnThesis/CommunityFirnThesis/Python/CFM/CFM_main/Air_OptiNoise_Ulti.json", 'w') as f:
        json.dump(data, f,indent = 2)
    
    # Closing file
    f.close()

    file = open(r'D:/GitHub/CommunityFirnThesis/CommunityFirnThesis/Python/CFM/CFM_main/FirnAir_Noise_Ulti.json')
    data = json.load(file)
    data['rhos0'] = 350.0

    with open(r"D:/GitHub/CommunityFirnThesis/CommunityFirnThesis/Python/CFM/CFM_main/FirnAir_Noise_Ulti.json", 'w') as f:
        json.dump(data, f,indent = 2)
...
def Data_crunch_Ulti(Model,Indices,sath,N,rho_surface_uncertainty_Flag,diff_param_Flag,bco_param_flag):
    ...
    for j,val in enumerate(Indices):
        ...
        d15N_dist = np.random.normal(np.asarray(mu_d15n),0.000001,size=N)
        ...
        for k in range(len(d15N_dist)):
            ...
            os.chdir(r'D:/GitHub/CommunityFirnThesis/CommunityFirnThesis/Python/')
...
Data_crunch_Ulti('HLD',Temp_input,path_Deff_only,100,False,True,False)
