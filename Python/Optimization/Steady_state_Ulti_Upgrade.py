# -*- coding: utf-8 -*-
"""
Created on Mon Apr 17 23:36:29 2023
...
def reset_to_factory():
    ...
    file = open(r'C:/Users/jespe/Documents/GitHub/CommunityFirnThesis/Python/CFM/CFM_main/Air_OptiNoise_Ulti.json')
    data = json.load(file)
    data['Diffu_param'] = 'Schwander'
    
    with open(r"C:/Users/jespe/Documents/GitHub/CommunityFirnThesis/Python/CFM/CFM_main/Air_OptiNoise_Ulti.json", 'w') as f:
        json.dump(data, f,indent = 2)
    
    # Closing file
    f.close()

    file = open(r'C:/Users/jespe/Documents/GitHub/CommunityFirnThesis/Python/CFM/CFM_main/FirnAir_Noise_Ulti.json')
    data = json.load(file)
    data['rhos0'] = 350.0

    with open(r"C:/Users/jespe/Documents/GitHub/CommunityFirnThesis/Python/CFM/CFM_main/FirnAir_Noise_Ulti.json", 'w') as f:
        json.dump(data, f,indent = 2)
...
def func(temp,N_ref,var_dict):
    ...
    np.savetxt(r'C:/Users/jespe/Documents/GitHub/CommunityFirnThesis/Python/CFM/CFM_main/CFMinput/OptiNoise/optimize_temp.csv', input_temp, delimiter=',')
    ...
    if os.path.exists(model_path):
        ...
        var_dict['rho_s'][count] = rhos#rho_0(temp,Acc)
...
def Data_crunch_Ulti(Model,Indices,sath,N,rho_surface_uncertainty_Flag,diff_param_Flag):
    ...
    for j,val in enumerate(Indices):
        ...
        for k in range(len(d15N_dist)):
            ...
            os.chdir(r'C:/Users/jespe/Documents/GitHub/CommunityFirnThesis/Python/')
            ...
            np.savetxt(r'C:/Users/jespe/Documents/GitHub/CommunityFirnThesis/Python/CFM/CFM_main/CFMinput/OptiNoise/optimize_acc.csv', input_acc, delimiter=',')
                
            os.chdir(r'C:/Users/jespe/Documents/GitHub/CommunityFirnThesis/Python/Optimization')
...
path3 = 'resultsFolder/Ulti3/'
#for j,val in enumerate(Input_temp):
Temp_input = np.array([5])

reset_to_factory()

Data_crunch_Ulti('HLD',Temp_input,path1,200,False,False)
Data_crunch_Ulti('HLD',Temp_input,path2,200,True,False)
Data_crunch_Ulti('HLD',Temp_input,path3,200,True,True)
#rint(Time)
