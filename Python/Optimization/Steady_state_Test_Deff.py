# -*- coding: utf-8 -*-
"""
Created on Sat Apr 29 22:45:19 2023
...
def reset_to_factory(file_id):
    ...
    file = open(r'D:/GitHub/CommunityFirnThesis/CommunityFirnThesis/Python/CFM/CFM_main/Air_OptiNoise_Ulti_'+str(file_id)+'.json')
    data = json.load(file)
    data['Diffu_param'] = 'Schwander'
    data['noisy_bco'] = False
    with open(r"D:/GitHub/CommunityFirnThesis/CommunityFirnThesis/Python/CFM/CFM_main/Air_OptiNoise_Ulti_"+str(file_id)+".json", 'w') as f:
...
def func(temp,N_ref,var_dict,bco_param_flag,file_id,model):
    ...
    np.savetxt(r'D:/GitHub/CommunityFirnThesis/CommunityFirnThesis/Python/CFM/CFM_main/CFMinput/OptiNoise/'+str(file_id)+'/optimize_temp.csv', input_temp, delimiter=',')
...
def Data_crunch_Ulti(sath,N,rho_surface_uncertainty_Flag,diff_param_Flag,bco_param_flag,model,file_id,d15n_std=0.02,Indices=Temp_input):
    ...
    for j,val in enumerate(Indices):
        ...
        for k in range(len(d15N_dist)):
            ...
            np.savetxt(r'D:/GitHub/CommunityFirnThesis/CommunityFirnThesis/Python/CFM/CFM_main/CFMinput/OptiNoise/' + str(file_id)+'/optimize_acc.csv', input_acc, delimiter=',')
