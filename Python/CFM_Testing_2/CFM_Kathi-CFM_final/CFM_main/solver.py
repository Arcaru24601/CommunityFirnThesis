...
def solver(a_U, a_D, a_P, b):
   ...
   # all_times = open('time/time_spdiags.txt', 'a+')
  ...
  #  end = time.time_ns()
   # total_time_nanoseconds = end - start
   # all_times = open('time/time_T2.txt', 'a+')
    #all_times.write(str(total_time_nanoseconds) + '\n')
   ...
   # end = time.time_ns()
   # total_time_nanoseconds = end - start
    #all_times = open('time/time_spsolve.txt', 'a+')
   # all_times.write(str(total_time_nanoseconds) + '\n')
...
def transient_solve_EN(z_edges, Z_P, nt, dt, Gamma_P, phi_0, nz_P, nz_fv, phi_s, mix_rho, c_vol, LWC, mass_sol, dz,
    ...
    mix_rho = (
                          mass_sol + mass_liq) / dz  # mixture, or total density of volume (solid plus liquid), see Aschwanden (2012)
    ...
    while itercheck > ICT:
        ...
        g_liq[g_liq > 0] = g_liq[g_liq > 0] + a_P[g_liq > 0] * (
                    (phi_t[g_liq > 0]) / (dZ[g_liq > 0] * deltaH[g_liq > 0]))  # dz or dZ?
        g_liq[g_liq <= 0] = 0
        g_liq[g_liq > 1] = 1
...
def w(z_airdict, Tz_airdict, dt_airdict, por_op_airdict, pressure_airdict, advection_type_airdict, por_tot_airdict,
    ...
    if advection_type_airdict == 'Darcy':
        ...
        #end = time.time_ns()
        #total_time_nanoseconds = end - start
        #all_times = open('time/time_interp1.txt', 'a+')
        #all_times.write(str(total_time_nanoseconds) + '\n')
       ...
       # end = time.time_ns()
       # total_time_nanoseconds = end - start
       # all_times = open('time/time_interp2.txt', 'a+')
       # all_times.write(str(total_time_nanoseconds) + '\n')
       ...
       # end = time.time_ns()
       # total_time_nanoseconds = end - start
       # all_times = open('time/time_interp3.txt', 'a+')
       # all_times.write(str(total_time_nanoseconds) + '\n')
       ...
       # end = time.time_ns()
       # total_time_nanoseconds = end - start
       # all_times = open('time/time_exp1.txt', 'a+')
       # all_times.write(str(total_time_nanoseconds) + '\n')
        ...
        #end = time.time_ns()
       # total_time_nanoseconds = end - start
       # all_times = open('time/time_where1.txt', 'a+')
        #all_times.write(str(total_time_nanoseconds) + '\n')
       ...
       # end = time.time_ns()
       # total_time_nanoseconds = end - start
        #all_times = open('time/time_where2.txt', 'a+')
        #all_times.write(str(total_time_nanoseconds) + '\n')
      ...
      #  start = time.time_ns()
       ...
       # end = time.time_ns()
        #total_time_nanoseconds = end - start
       # all_times = open('time/time_where3.txt', 'a+')
        #all_times.write(str(total_time_nanoseconds) + '\n')
       ...
       # end = time.time_ns()
       # total_time_nanoseconds = end - start
       # all_times = open('time/time_reshape1.txt', 'a+')
       # all_times.write(str(total_time_nanoseconds) + '\n')
       ...
       # end = time.time_ns()
       # total_time_nanoseconds = end - start
       # all_times = open('time/time_reshape2_log.txt', 'a+')
       # all_times.write(str(total_time_nanoseconds) + '\n')
       ...
       # end = time.time_ns()
        #total_time_nanoseconds = end - start
       # all_times = open('time/time_T.txt', 'a+')
        #all_times.write(str(total_time_nanoseconds) + '\n')

       # start = time.time_ns()
        #integral_matrix_sum = integral_matrix.sum(axis=1)
        integral_matrix_sum = np.sum(integral_matrix, axis=1)
       # end = time.time_ns()
       # total_time_nanoseconds = end - start
       # all_times = open('time/time_sum.txt', 'a+')
       # all_times.write(str(total_time_nanoseconds) + '\n')
       ...
       # end = time.time_ns()
       # total_time_nanoseconds = end - start
       # all_times = open('time/time_zeros_like.txt', 'a+')
        #all_times.write(str(total_time_nanoseconds) + '\n')
      ...
      #  start = time.time_ns()
       ...
       # end = time.time_ns()
       # total_time_nanoseconds = end - start
       # all_times = open('time/time_minimum.txt', 'a+')
       # all_times.write(str(total_time_nanoseconds) + '\n')
