...
resultsFileName_Spin = 'CFMresults_NGRIP_random_110-10kyr_300m_2yr_inversion-LS_SPIN2_2022-08-01_01.hdf5'
resultsFileName_Main = 'CFMresults_NGRIP_random_110-10kyr_300m_2yr_inversion-LS_MAIN_2022-08-01_01.hdf5'

spin2_path = '../../CFM_main/resultsFolder/' + resultsFileName_Spin
model_path = '../../CFM_main/resultsFolder/' + resultsFileName_Main

finalResults_path_modelruns = '~/projects/finalResults/inversion/random_long_LS_2022-08-01_02'

json_SPIN = 'FirnAir_NGRIP_random_long.json'
json_MAIN = 'FirnAir_NGRIP_Spin2_random_long.json'
json_AirConfig = 'AirConfig.json'

# optimization parameter files
results_minimizer_spin_path = 'resultsFolder/2022-08-01_01_random_LS_resultsInversion_minimizer_SPIN.h5'
results_minimizer_main_path = 'resultsFolder/2022-08-01_01_random_LS_resultsInversion_minimizer.h5'
...
list_densification = ['Barnola1991', 'HLdynamic', 'Goujon2003', 'HLSigfus']
list_gas_diff = ['Christo', 'Darcy', 'zero', 'man']
...
def fun_Spin(theta):
    ...
    with open(json_SPIN, 'r+') as json_file:
        ...
        cfm_params['physRho'] = list_densification[rand1]
        json_file.seek(0)
        json.dump(cfm_params, json_file, indent=4)
        json_file.truncate()
        json_file.close()
    with open(json_AirConfig, 'r+') as json_file:
        cfm_params = json.load(json_file)
        cfm_params['advection_type'] = list_gas_diff[rand3]
        json_file.seek(0)
        json.dump(cfm_params, json_file, indent=4)
        json_file.truncate()
        json_file.close()
